    ...
    return (
        ...
        >
            <div className="form-group has-feedback">
                <label className="txt-18-n color-057" htmlFor="first_name">
                    Nombre
                </label>
                <Field
                    name="first_name"
            ...
            <div className="form-group has-feedback">
                <label className="txt-18-n color-057" htmlFor="last_name">
                    Apellido
                </label>
                <Field
                    name="last_name"
            ...
            <div className="form-group has-feedback">
                <label className="txt-18-n color-057" htmlFor="username">
                    Usuario
                </label>
                <Field
                    name="username"
            ...
            <div className="form-group has-feedback">
                <label className="txt-18-n color-057" htmlFor="password">
                    Contraseña
                </label>
                <Field
                    name="password"
            ...
            <div className="form-group has-feedback">
                <label className="txt-18-n color-057" htmlFor="confirmPassword">
